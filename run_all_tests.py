...
class TestRunner:
    ...
    def run_all_tests(self):
        ...
        tests = [
            ...
            (self.testing_dir / 'e2e' / 'experience' / 'test_experience_crud.py', 'Work Experience CRUD'),
            (self.testing_dir / 'e2e' / 'certifications' / 'test_certifications_crud.py', 'Certifications/Education CRUD'),
            (self.testing_dir / 'e2e' / 'miniatures' / 'test_miniatures_comprehensive.py', 'Miniatures Comprehensive'),
        ]
        ...
        if failed > 0:
            ...
            for result in self.results:
                if not result['success']:
                    error_msg = result.get('error', f"Exit code: {result.get('returncode', 'unknown')}")
