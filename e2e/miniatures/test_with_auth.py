...
def test_miniatures_with_auth():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            projects_tab = page.locator('[role="tab"]:has-text("Projects"), .n-tab:has-text("Projects"), text=Projects').first
            themes_tab = page.locator('[role="tab"]:has-text("Themes"), .n-tab:has-text("Themes"), text=Themes').first
            paints_tab = page.locator('[role="tab"]:has-text("Paints"), .n-tab:has-text("Paints"), text=Paints').first
