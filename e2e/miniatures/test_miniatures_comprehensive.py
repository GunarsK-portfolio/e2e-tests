                ...
                if add_btn.count() > 0:
                    ...
                    if modal.count() > 0:
                        ...
                        fields = {
                            ...
                            "display_order": page.locator(
                                'input[type="number"], input[placeholder*="order" i]'
                            ).first,
                        }
                ...
                if add_btn.count() > 0:
                    ...
                    if modal.count() > 0:
                        ...
                        fields = {
                            ...
                            "name": page.locator('input[placeholder*="name" i]').first,
                            "color_code": page.locator(
                                'input[placeholder*="color" i], input[type="color"]'
                            ).first,
