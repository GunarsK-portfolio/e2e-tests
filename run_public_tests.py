#!/usr/bin/env python3
"""
Public-Web Test Suite Runner
Runs E2E tests for public-web application (no authentication required)
"""
...
class PublicTestRunner:
    ...
    def run_tests(self):
        ...
        print("\n" + "=" * 70)
        print("PUBLIC-WEB E2E TEST SUITE")
        print("=" * 70)
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 70)
        print("PUBLIC-WEB TEST SUITE SUMMARY")
        print("=" * 70)
...
def main():
    ...
    if args.no_confirm or not sys.stdin.isatty():
        ...
        print("PUBLIC-WEB E2E TEST SUITE")
        print("=" * 70)
        print("\nRunning public-web E2E tests...")
    else:
        print("\n" + "=" * 70)
        print("PUBLIC-WEB E2E TEST SUITE")
        print("=" * 70)
        print("\nThis will run public-web E2E tests.")
        print("Requires public-web and public-api services running.")
